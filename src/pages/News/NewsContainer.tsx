...
import { getContent, getNewsByCategory, getNewsThunk } from "../../redux/reducers/newsReducer";
import { TGlobalState } from "../../redux/reduxStore";
import { getCategoriesSelector, getHasContent, getIsFetching, getNews, getNextPageSelector, getScrollFetchingSelector } from "../../redux/selectors/newsSelector";
